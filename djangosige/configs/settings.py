...
ALLOWED_HOSTS = ['*'] # Simplificado para teste, ajuste conforme necessário para produção)
CSRF_TRUSTED_ORIGINS = ["https://8000-i4060fb1yr0ickkep448c-5d7bbe1e.manus.computer"]
...
INSTALLED_APPS = [
    ...
    "licenciamento.apps.LicenciamentoConfig", # Novo app adicionado
]
